...
void PlanningVisualization::displayMultiInitPathList(vector<vector<Eigen::Vector3d>> init_trajs,
                                                     const double                    scale) {
...
void PlanningVisualization::displayCentralInitPathList(std::vector<Eigen::MatrixXd> cstr_ptss,
                                                       const double                 scale) {
...
void PlanningVisualization::displayECBSpoints(std::vector<Eigen::Vector3d> points,
                                              Eigen::Vector4d              color,
                                              int                          id) {
...
void PlanningVisualization::displayAStarList(std::vector<std::vector<Eigen::Vector3d>> a_star_paths,
  ...
  Eigen::Vector4d color =
      Eigen::Vector4d(0.5 + ((double)rand() / RAND_MAX / 2), 0.5 + ((double)rand() / RAND_MAX / 2),
